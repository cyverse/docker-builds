...
grep -vwf Homology_Search/List_of_identified_putative_orthologs.txt Homology_Search/List_of_all_query_lincRNAs.txt | sed 's~^~List_of_non_identified_lincRNAs\n~' > Homology_Search/List_of_non_identified_query_lincRNAs.txt
