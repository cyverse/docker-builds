...
awk '{ if ($2 == $6) { print $2;} else { pass;} }' <Reciprocal_BLAST_Return/$Put_ortholog.reciprocal.comparison.filtered.gff >Reciprocal_BLAST_Return/$Put_ortholog.reciprocal.IDs.list.txt
...
sleep 5
grep -f Reciprocal_BLAST_Return/$Put_ortholog.reciprocal.Unique.IDs.list.txt Reciprocal_BLAST_Return/$Put_ortholog.reciprocal.Unique.IDs.almost.txt >Reciprocal_BLAST_Return/$Put_ortholog.reciprocal.comparison.TBH.filtered.gff
...
python /extract_sequences.py Reciprocal_BLAST_Return/$Put_ortholog.reciprocal.final.list.for.pooling.families.txt ../Orthologs/$Put_ortholog.orthologs.identified.fasta ../Orthologs/$Put_ortholog.orthologs.only.fasta
